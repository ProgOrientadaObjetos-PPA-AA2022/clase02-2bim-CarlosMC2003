...
public class EstudiantePresencial extends Estudiante{
    ...
    public EstudiantePresencial(String nom, String ap, String iden, int e, 
            int numCre, double costoCre){
        super(ap, iden, e);
        establecerNombresEstudiante(nom);
        numeroCreditos = numCre;
        costoCredito = costoCre;
    }
    
    public EstudiantePresencial( String ap, String iden, int e){
        super(ap, iden, e);
